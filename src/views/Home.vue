<template>
  <v-container>
    <v-layout row wrap align-content-space-around>
      <v-col cols="12" sm="12" md="6" xl="6" class="mt-4" align="center">
